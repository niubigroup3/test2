...
public class OrderService {
	 ...
	 * @see {@link Order}
	 */
	public boolean createOrder(Object order) throws IllegalArgumentException {
		/*
		 * List<Goods> items = order.getItems(); items.forEach(goods -> { BigDecimal
		 * quantity = goods.getQuantity(); if (quantity == null ||
		 * BigDecimal.ZERO.compareTo(quantity) == 0) { throw new
